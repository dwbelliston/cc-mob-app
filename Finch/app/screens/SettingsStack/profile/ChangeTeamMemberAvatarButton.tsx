...
TODO: Lotsof dupe code compared to the attach file button and ChangeAvatarButton
*/
...
import useUploadTeamMemberMedia from "../../../services/api/teammembers/mutations/useUploadTeamMemberMedia"
import { spacing } from "../../../theme"
import { useCustomToast } from "../../../utils/useCustomToast"
import { runTodayTimestamp } from "../../../utils/useFormatDate"

export interface IChangeTeamMemberAvatarButtonProps extends IconButtonProps {
  teamMemberId: string
...
export const ChangeTeamMemberAvatarButton = ({
  teamMemberId,
  onFileSelect,
  documentPickerOptions,
  imagePickerOptions,
  ...rest
}: IChangeTeamMemberAvatarButtonProps) => {
  const toast = useCustomToast()

  const { mutateAsync: mutateAsyncUpload, isLoading: isLoadingUpload } = useUploadTeamMemberMedia()
  ...
  const uploadMediaFile = async (selectedFile: ISelectedFile, maxAllowSize = MAXALLOWEDSIZE) => {
    ...
    try {
      const res = await mutateAsyncUpload({ teamMemberId: teamMemberId, file: formData })
